...
var ProductsByCategory = /** @class */ (function () {
    function ProductsByCategory(navCtrl, navParams, ngZone, toastCtrl, wp) {
        ...
        this.WooCommerce.getAsync('products?category=' + this.id).then(function (data) {
            console.log(data);
    ...
    ProductsByCategory.prototype.loadMoreProducts = function (event) {
        ...
        console.log(event);
        this.page++;
        this.WooCommerce.getAsync('products?category=' + this.id + '&page=' + this.page).then(function (data) {
