...
var WooCommerceProvider = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        if (!affiliateId) {
                            console.log("No affiliate code added");
                            resolve("No affiliate entered");
                        }
                        ...
                        _this.http.get(_this.uapRestUrlV1 + "/get-affiliate-rank-details/" + affiliateId, { headers: headers })
                            ...
                            var affRankDetail = JSON.parse(data);
                            if (affRankDetail.id > 0) {
                                resolve(affRankDetail);
                            }
                            else {
                                reject({ errorCode: "-1", "error._body": "Affiliate is not affiliate!..." });
                            }
    ...
    WooCommerceProvider.prototype.addOrderReferral = function (userId, reference, orderTotal, currency) {
        /*
        ...
        */
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.getUserReferrer(userId).then(function (affiliateId) { return __awaiter(_this, void 0, void 0, function () {
                var rankDetails, referralAmount, addReferralData, headers;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log("############", affiliateId);
                            if (!(affiliateId > 0)) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.getAffiliateRankDetails(affiliateId)];
                        case 1:
                            rankDetails = _a.sent();
                            ...
                            //get rank amount and other affiliate data
                            console.log("@@@@@@@@@@@@", rankDetails);
                            referralAmount = void 0;
                            addReferralData = void 0;
                            ...
                            return [3 /*break*/, 3];
                        case 2:
                            reject({ 'error': "affiliate does not exist", 'description': "همکار فروش با این کد وجود ندارد." });
                            _a.label = 3;
    ...
    WooCommerceProvider.prototype.addSignupReferral = function (userId, rankDetails, affiliateId) {
    ...
    WooCommerceProvider.prototype.addAffiliateRelation = function (affiliateId, referralWpUid) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAffiliateRankDetails(affiliateId)];
                    case 1:
                        res = _a.sent();
                        if (!res)
                            return [2 /*return*/];
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\test-mmarket\src\app\app.html"*/'<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n<ion-footer style="z-index:1000; background-color:gainsboro" *ngIf="disconnect">\n    <ion-label text-center block color="danger">\n        <b>ارتباط با شبکه برقرار نیست</b>\n      </ion-label>\n</ion-footer>'/*ion-inline-end:"D:\test-mmarket\src\app\app.html"*/
        }),
