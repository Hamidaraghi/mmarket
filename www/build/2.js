...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_http__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_map__ = __webpack_require__(917);
...
var Signup = /** @class */ (function () {
    function Signup(navCtrl, navParams, toastCtrl, alertCtrl, loadingCtrl, formBuilder, wp, http) {
        ...
        this.signupValidator = formBuilder.group({
            firstName: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].pattern('[a-zA-Zا-ی ]*')])],
            lastName: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].pattern('[a-zA-Zا-ی ]*')])],
            ...
            affiliateId: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].pattern('[0-9]*')]
        });
    ...
    Signup.prototype.signup = function () {
        ...
        this.WooCommerce.postAsync('customers', customerData).then(function (data) {
            if (data.statusCode == 201) {
                ...
                if (_this.affiliateId) {
                    var referralWpUid_1 = JSON.parse(data.body).id;
                    console.log("referralWpUid is:", referralWpUid_1);
                    //add relation between affiliate and referral
                    _this.wp.addAffiliateRelation(_this.affiliateId, referralWpUid_1);
                    //get rank amount and other affiliate data
                    _this.wp.getAffiliateRankDetails(_this.affiliateId).then(function (data) {
                        console.log("@@@@@@@@@@@@@@@@@@@", data);
                        var rankDetails = data;
                        if (rankDetails.sign_up_amount_value >= 0) {
                            //add referral          
                            var addReferralData = {
                                "refferal_wp_uid": referralWpUid_1, "campaign": "", "affiliate_id": _this.affiliateId, "visit_id": "", "description": "register user via app",
                                "source": "app signup", "reference": "userSignup:" + referralWpUid_1, "reference_details": "app-register", "parent_referral_id": "", "child_referral_id": "",
    ...
    Signup = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["u" /* ToastController */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__providers_woo_commerce_woo_commerce__["a" /* WooCommerceProvider */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */]])
    ], Signup);
    return Signup;
}());
