...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__order_details__ = __webpack_require__(930);
...
var OrderDetailsPageModule = /** @class */ (function () {
    ...
    OrderDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_0__order_details__["a" /* OrderDetails */]],
            imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__order_details__["a" /* OrderDetails */]), __WEBPACK_IMPORTED_MODULE_3__app_shared_module__["a" /* SharedModule */]],
        })
...
var OrderDetails = /** @class */ (function () {
    function OrderDetails(navCtrl, navParams, wp, ngZone) {
        var _this = this;
        ...
        var _loop_1 = function (i) {
            this_1.WooCommerce.getAsync("products/" + this_1.moreProducts[i].product_id).then(function (product) {
                product = JSON.parse(product.body);
                _this.ngZone.run(function () {
                    _this.images[i] = product.images[0].src;
