...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checkout__ = __webpack_require__(922);
...
var CheckoutPageModule = /** @class */ (function () {
    ...
    CheckoutPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_0__checkout__["a" /* Checkout */]],
            imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__checkout__["a" /* Checkout */])],
        })
    ], CheckoutPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cart_cart__ = __webpack_require__(400);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_in_app_browser__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(923);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ionic_angular_components_loading_loading_controller__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_forms__ = __webpack_require__(40);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Checkout = /** @class */ (function () {
    function Checkout(navCtrl, navParams, viewCtrl, loadingCtrl, storage, alertCtrl, inAppbrowser, formBuilder, wp, ngZone) {
        var _this = this;
        ...
        this.checkoutValidator = formBuilder.group({
            firstName: ['نام', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].pattern('[a-zA-Zا-ی ]*')])],
            lastName: ['نام خانوادگی', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].pattern('[a-zA-Zا-ی ]*')])],
            email: ['example@example.com', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$')],
            cityState: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required],
            postCode: ['4912345678', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].pattern('[0-9]*'), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].maxLength(10)])],
            phone: ['09123456789', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].pattern('[0-9]*'), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].maxLength(11), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].minLength(11)])],
            address: ['آدرس', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].minLength(10), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].maxLength(100)])],
            shippingMethod: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required],
            paymentMethod: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].required],
            rules: ['false', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* Validators */].requiredTrue]
        });
        this.showSpinner();
        this.newOrder = {};
        ...
        var promises = [];
        promises.push(this.gateways.getAsync('shipping/zones').then(function (data) {
            console.log(JSON.parse(data.body));
            _this.cityStates = __WEBPACK_IMPORTED_MODULE_6_lodash__["values"](JSON.parse(data.body));
            console.log(_this.cityStates);
        }, function (error) { ; console.log(error); }));
        promises.push(this.gateways.getAsync('payment_gateways').then(function (data, res, err) {
            console.log('Gateways:', __WEBPACK_IMPORTED_MODULE_6_lodash__["values"](JSON.parse(data.body)));
            _this.paymentMethods = __WEBPACK_IMPORTED_MODULE_6_lodash__["values"](JSON.parse(data.body));
        ...
        promises.push(this.storage.get("userLoginInfo").then(function (userLoginInfo) {
            ...
            _this.gateways.getAsync('customers/' + id).then(function (data) {
                _this.newOrder = JSON.parse(data.body);
                console.log(JSON.parse(data.body));
            });
        }, function (err) { console.log(err); alert(err); }));
        promises.push(this.storage.get('cart').then(function (cart) {
            _this.cart = cart;
            _this.cartTotal = 0;
            _this.orderItems = [];
            cart.forEach(function (element, index) {
                ...
                _this.cartTotal += element.qty * element.product.price;
            }); // // en cart.forEach
        }, function (error) { console.log(error); })); // end of  this.storage.get('cart')
        Promise.all(promises).then(function () {
            //this.updateCart().then(data=>{console.log(data)});
            _this.hideSpinner();
        });
    } // End of constructor !
    Checkout.prototype.onCityStateChange = function (selectedValue) {
        var _this = this;
        this.showSpinner();
        console.log('Selected', selectedValue);
        //List all location of a zone:
        this.gateways.getAsync('shipping/zones/' + selectedValue + '/locations').then(function (data) {
            console.log(JSON.parse(data.body));
        });
        //list all shipping methods of a zone:
        this.gateways.getAsync('shipping/zones/' + selectedValue + '/methods').then(function (res) {
            ...
            var _loop_1 = function (i) {
                ...
                if (orderShippingLine[i].method_id == 'free_shipping') {
                    ...
                    var minFreeShippingAmount = parseInt(orderShippingLine[i].settings.min_amount.value);
                    console.log(_this.cartTotal);
                    if (_this.cartTotal < minFreeShippingAmount) {
                    ...
                    console.log(_this.shippingAmount);
                    console.log(__WEBPACK_IMPORTED_MODULE_6_lodash__["values"](orderShippingLine[i].settings));
                    var classes = __WEBPACK_IMPORTED_MODULE_6_lodash__["values"](orderShippingLine[i].settings);
                    var noClassCost_1 = orderShippingLine[i].settings.no_class_cost;
                    var classCost_1 = [];
                    classes.forEach(function (cost, index) {
                        if (cost.id.toString().startsWith("class_cost_")) {
                            console.log('1397/06/22', cost);
                            classCost_1.push(cost);
                        }
                    }); // End forEach(classes)
                    // calculating shippin cost per class:
                    if (classCost_1 != null && classCost_1.length > 0) {
                        ...
                        total = 0;
                        cartItemCalssCost = 0;
                        console.log('classcost', classCost_1);
                        for (var h = 0; h < _this.cart.length; h++) {
                            for (var j = 0; j < classCost_1.length; j++) {
                                if ('class_cost_' + _this.cart[h].product.shipping_class_id == classCost_1[j].id) {
                                    console.log(_this.cart[h].qty);
                                    qty = (_this.cart[h]).qty;
                                    console.log('139500000000');
                                    console.log(eval(classCost_1[j].value));
                                    console.log(orderShippingLine);
                                    console.log(h);
                                    cartItemCalssCost = eval(classCost_1[j].value);
                                    if (max < cartItemCalssCost) {
                                        max = cartItemCalssCost;
                                    }
                        ...
                        if (orderShippingLine[i].settings.type.value == 'class') {
                            ...
                            orderShippingLine[i].shippingAmount = max;
                        }
                        ...
                        _this.cart.forEach(function (item, index) {
                            ...
                            if (item.product.shipping_class_id == 0 || item.product.shipping_class_id == null) {
                                qty = item.qty;
                                orderShippingLine[i].shippingAmount += eval(noClassCost_1.value);
                                console.log("ShippingAmount:", orderShippingLine[i].shippingAmount);
                            }
                        });
                        // end of get cart
                ...
                _this.shippingMethods = orderShippingLine;
                console.log(_this.shippingMethods);
                out_i_1 = i;
            };
            var qty, max, total, cartItemCalssCost, out_i_1;
            for (var i = 0; i < orderShippingLine.length; i++) {
                _loop_1(i);
                i = out_i_1;
            }
            ; // end  for (let i = 0; i< orderShippingLine.length; i++)
            _this.hideSpinner();
        }, function (error) { alert(error); _this.hideSpinner(); }); // end of this.gateways.getAsync('shipping/zones/' + selectedValue + '/methods')
    }; // end of onCityStateChange()
    Checkout.prototype.onShippingChange = function (selectedValue) {
    ...
    Checkout.prototype.updateCart = function () {
        var _this = this;
        var altered = false;
        this.cartTotal = 0;
        return new Promise(function (resolve, reject) {
            ...
            var _loop_2 = function (i) {
                ...
                promise = _this.gateways.getAsync('products/' + _this.cart[i].product.id).then(function (productData) {
                    ...
                    if (productData.statusCode == 200 && freshProduct.status != "trash" && freshProduct.price != '') {
                        ...
                        _this.cart[i].product = freshProduct;
                        if (!freshProduct.in_stock) {
                            console.log("Product is no longer available!");
                            alert(_this.cart[i].product.name + 'در حال حاضر موجود نیست، بنابراین از سبد شما حذف می شود .');
                            altered = true;
                            _this.cart[i] = null;
                            return;
                        }
                        //if cart item qty is grarter than max stock quantity
                        if (_this.cart[i].product.stock_quantity != null && _this.cart[i].qty > _this.cart[i].product.stock_quantity) {
                            _this.cart[i].qty = _this.cart[i].product.stock_quantity;
                            alert("درخواست شما برای " + _this.cart[i].product.name + " بیش از حداکثر موجودی انبار می باشد. مقدار درخواستی شما به بیشترین مقدار موجود اصلاح شد.");
                            altered = true;
                        }
                        // if product is for sold_individually
                        if (_this.cart[i].product.sold_individually && _this.cart[i].qty > 1) {
                            alert(_this.cart[i].product.name + " به صورت تکی به فروش می رسد، بنابراین تعداد آن نمی تواند بیش از 1 مورد در هر سفارش باشد.");
                            altered = true;
                            _this.cart[i].qty = 1;
                        }
                        console.log(_this.cartTotal);
                        _this.cartTotal += _this.cart[i].product.price * _this.cart[i].qty;
                        console.log(_this.cartTotal);
                    } // end if statuscode = 200
                    else if (productData.statusCode == 404 || freshProduct.status == "trash" || freshProduct.price == "" || !freshProduct.in_stock) {
                        console.log("Product is no longer available!");
                        alert(_this.cart[i].product.name + 'در حال حاضر موجود نیست، بنابراین از سبد شما حذف می شود .');
                        altered = true;
                        _this.cart[i] = null;
            ...
            Promise.all(promises).then(function () {
                ...
                console.log('promise....', _this.cart);
                resolve([_this.cart, altered]);
            }, function (error) { console.log(error); reject(error); });
        });
    }; // end of updateCart()
    /////////////////***Place order****////////////////
    Checkout.prototype.placeOrder = function (order, updateCart, addCoupon) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var regExp, data, rawOrderData, orderData;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (regExp.test(this.data.customer_note)) {
                            ...
                            return [2 /*return*/, ({ "error": "invalid_params", "error_message": " متن یادداشت سفارش شما حاوی عبارات غیر مجاز می باشد." })];
                        }
                        ...
                        if (!updateCart) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.updateCart()];
                    case 1:
                        data = _a.sent();
                        console.log("DDDDDaaaata is::::::::::;", data);
                        if (data[0] == null || data.length == 0 || data[1]) {
                            console.log('Cart is null or Altered');
                            this.navCtrl.popTo(__WEBPACK_IMPORTED_MODULE_0__cart_cart__["a" /* Cart */]);
                            return [2 /*return*/];
                        }
                        _a.label = 2;
                    case 2:
                        this.paymentMethods.forEach(function (element, index) {
                            if (element.id == _this.paymentMethod) {
                                _this.paymentData = element;
                        ...
                        if (!(order && order.id)) return [3 /*break*/, 4];
                        //prevent doubling line items when put request is going
                        delete this.data.line_items;
                        return [4 /*yield*/, this.gateways.putAsync('orders/' + order.id, this.data)];
                    case 3:
                        rawOrderData = _a.sent();
                        ...
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.gateways.postAsync('orders', this.data)];
                    case 5:
                        rawOrderData = _a.sent();
                        orderData = JSON.parse(rawOrderData.body);
                        ...
                        if (addCoupon) {
                            return [2 /*return*/, Promise.resolve(orderData)];
                        }
                        // add referral
                        //get rank amount and other affiliate data
                        this.wp.getUserReferrer(this.userInfo.id).then(function (affiliateId) {
                            console.log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@", affiliateId);
                            if (affiliateId > 0) {
                                //get rank amount and other affiliate data
                                _this.wp.getAffiliateRankDetails(affiliateId).then(function (data) {
                                    console.log("@@@@@@@@@@@@@@@@@@@", data);
                                    ...
                                    var addReferralData = { "refferal_wp_uid": _this.userInfo.id, "campaign": "", "affiliate_id": affiliateId, "visit_id": "", "description": "", "source": "woo",
                                    ...
                                    _this.wp.addReferral(addReferralData);
                                });
                            }
                        });
                        _a.label = 6;
                    case 6:
                        if (this.paymentData.id == "WC_Saman_Gateway") {
    ...
    Checkout.prototype.showSpinner = function () {
        this.spinner = this.loadingCtrl.create();
        this.spinner.present();
    };
    Checkout.prototype.hideSpinner = function () {
        this.spinner.dismiss();
    };
    Checkout.prototype.checkEmail = function () {
    ...
    Checkout.prototype.updateUserInformation = function (userId, data) {
        this.gateways.put('customers/' + userId, data, function (err, data, res) {
    ...
    Checkout.prototype.payWithSepGateway = function (order) {
        var _this = this;
        ...
        this.wp.WooCommerce3.getAsync('sep/v1/get-token/?Action=Token&TerminalId=' + this.wp.TerminalId +
            ...
            '&Amount=' + amount + '&CellNumber=' + this.newOrder.billing.phone.toString()).then(function (sepData) {
                    ...
                    browserRef.on('loadstop').subscribe(function (loadstop) {
                        ...
                        browserRef.executeScript({ code: scriptCode }).then(function (value) {
                            ...
                            if (sep.State != 'OK' || sep.Status != 2) {
                                _this.gateways.postAsync('orders/' + order.id + '/notes', { note: "وضعیت تراکنش درگاه سامان اوکی نمیباشد" + sep.State });
                                _this.gateways.putAsync('orders/' + order.id, { status: 'cancelled' }).then(function (data) {
                                    console.log(data);
                                    console.log(JSON.parse(data.body));
                                }, function (error) { console.log(error); });
                                alert(" خطا در پرداخت. شماره خطا: " + sep.Status);
                                _this.gateways.postAsync('orders/' + order.id + '/notes', { note: " خطا در پرداخت. شماره خطا: " + sep.Status });
                                _this.gateways.putAsync('orders/' + order.id, { status: 'cancelled' }).then(function (data) {
                                    console.log(data);
                                    console.log(JSON.parse(data.body));
                                }, function (error) { console.log(error); });
                                ...
                                _this.wp.WooCommerce3.postAsync('sep/v1/save-RefNum', seveRefNumData).then(function (data) {
                                    ...
                                    if (res.error) {
                                        ...
                                        _this.gateways.postAsync('orders/' + order.id + '/notes', { note: res.error_description });
                                        _this.gateways.putAsync('orders/' + order.id, { status: 'cancelled' }).then(function (data) {
                                            console.log(data);
                                            console.log(JSON.parse(data.body));
                                        }, function (error) { console.log(error); });
                                    ...
                                    if (res.inserted) {
                                        ...
                                        _this.sepVerify(verifyArgs).then(function (verifyData) {
                                            if (verifyData.error) {
                                                _this.gateways.postAsync('orders/' + order.id + '/notes', { note: "خطا: " + JSON.stringify(verifyData.description) });
                                                _this.gateways.putAsync('orders/' + order.id, { status: 'cancelled' }).then(function (data) {
                                                    console.log(data);
                                                    console.log(JSON.parse(data.body));
                                                }, function (error) { console.log(error); });
                                                ...
                                                _this.gateways.postAsync('orders/' + order.id + '/notes', { note: "وریفای موفق؛ کد پیگیری: " + sep.TraceNo.toString() });
                                                _this.gateways.putAsync('orders/' + order.id, { set_paid: true, status: 'processing', transaction_id: sep.RefNum.toString() }).then(function (order) {
                                                    _this.storage.remove('cart');
                                                    if (_this.spinner)
                                                        _this.hideSpinner();
                                                    _this.orderFinalMessage(order, true);
                                                });
                                                _this.updateUserInformation(_this.userInfo.id, _this.newOrder);
                                            }
                                        });
                                    }
                                });
    ...
    Checkout.prototype.sepVerify = function (verifyArgs) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    Checkout.prototype.orderFinalMessage = function (orderData, success) {
        var _this = this;
        if (success) {
    ...
    //   })
    // }
    Checkout.prototype.insertCoupon = function (orderID, couponCode) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.coupon_lines.push({ "code": couponCode });
                if (orderID) {
                    this.wp.WooCommerce3.putAsync('orders/' + orderID, { "coupon_lines": this.coupon_lines }).then(function (putedOrder) {
                        console.log(JSON.parse(putedOrder.body));
                        if (putedOrder.statusCode == 400) {
                            alert("کد کوپن معتبر نمی باشد");
                            _this.coupon_lines.pop();
                            _this.hideSpinner();
                            return;
                        }
                        ...
                        _this.ngZone.run(function () {
                            _this.couponLines = putedOrder.coupon_lines;
                            console.log(_this.couponLines);
                        });
                        //update order totals:
                        _this.orderData = putedOrder;
                        if (_this.spinner) {
                            _this.hideSpinner();
                        }
                    });
                    ...
                    this.placeOrder(null, false, true).then(function (orderData) {
                        console.log('?????????????????????????', orderData);
                        _this.wp.WooCommerce3.putAsync('orders/' + orderData.id, { "coupon_lines": _this.coupon_lines }).then(function (putedData) {
                            console.log(putedData);
                            if (putedData.statusCode == 400) {
                                alert("کد کوپن معتبر نمی باشد");
                                _this.coupon_lines.pop();
                                _this.hideSpinner();
                                return;
                            ...
                            console.log(putedData);
                            _this.ngZone.run(function () {
                                _this.couponLines = putedData.coupon_lines;
                                console.log(_this.couponLines);
                            });
                            // update totals in page:
                            _this.orderData = putedData;
                            if (_this.spinner) {
                                _this.hideSpinner();
                            }
                        });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(218)(module)))
