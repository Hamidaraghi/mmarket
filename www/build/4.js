...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_woo_commerce_woo_commerce__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(923);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular_components_loading_loading_controller__ = __webpack_require__(125);
...
var Checkout = /** @class */ (function () {
    function Checkout(navCtrl, navParams, viewCtrl, loadingCtrl, storage, alertCtrl, formBuilder, wp, ngZone) {
        var _this = this;
        ...
        this.checkoutValidator = formBuilder.group({
            firstName: ['نام', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].pattern('[a-zA-Zء-ی ]*')])],
            lastName: ['نام خانوادگی', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].pattern('[a-zA-Zء-ی ]*')])],
            email: ['example@example.com', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$')],
            cityState: ['', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required],
            postCode: ['4912345678', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].pattern('[0-9]*'), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].maxLength(10)])],
            phone: ['09123456789', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].pattern('[0-9]*'), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].maxLength(11), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].minLength(11)])],
            address: ['آدرس', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].minLength(10), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].maxLength(100)])],
            shippingMethod: ['', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["f" /* Validators */].required],
        });
        this.showSpinner();
        this.newOrder = {};
        ...
        promises.push(this.gateways.getAsync('shipping/zones').then(function (data) {
            ...
            _this.cityStates = __WEBPACK_IMPORTED_MODULE_5_lodash__["values"](JSON.parse(data.body));
        ...
        this.gateways.getAsync('shipping/zones/' + selectedValue + '/methods').then(function (res) {
            ...
            var _loop_1 = function (i) {
                ...
                if (orderShippingLine[i].method_id == 'free_shipping') {
                    ...
                    console.log(__WEBPACK_IMPORTED_MODULE_5_lodash__["values"](orderShippingLine[i].settings));
                    var classes = __WEBPACK_IMPORTED_MODULE_5_lodash__["values"](orderShippingLine[i].settings);
    ...
    Checkout.prototype.updateUserData = function () {
        this.userInfoUpdateFlage = true;
    };
    Checkout.prototype.updateUserInformation = function (userId, data, flag) {
        if (flag == false) {
            console.log("No changes made in user information");
            return;
        }
        this.wp.WooCommerce3.putAsync('customers/' + userId, data).then(function (data) {
            console.log(data);
