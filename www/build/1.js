...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyordersPagePageModule", function() { return MyordersPagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__myorders__ = __webpack_require__(929);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_shared_module__ = __webpack_require__(918);
...
var MyordersPagePageModule = /** @class */ (function () {
    function MyordersPagePageModule() {
    }
    MyordersPagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_0__myorders__["a" /* MyordersPage */]],
            imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__myorders__["a" /* MyordersPage */]), __WEBPACK_IMPORTED_MODULE_3__app_shared_module__["a" /* SharedModule */]],
        })
    ], MyordersPagePageModule);
    return MyordersPagePageModule;
}());
...
;(function (global, factory) {
    true ? factory(__webpack_require__(789)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pipes_jalali_jalali__ = __webpack_require__(919);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_1__pipes_jalali_jalali__["a" /* JalaliPipe */]],
            exports: [__WEBPACK_IMPORTED_MODULE_1__pipes_jalali_jalali__["a" /* JalaliPipe */]]
        })
    ], SharedModule);
    return SharedModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jalali_moment__ = __webpack_require__(920);
...
var JalaliPipe = /** @class */ (function () {
    ...
    JalaliPipe.prototype.transform = function (value, args) {
        ...
        var MomentDate = __WEBPACK_IMPORTED_MODULE_1_jalali_moment__(value).locale('fa').format('YYYY/M/D HH:mm:ss');
        return MomentDate;
    };
...
var moment = __webpack_require__(789);
...
var MyordersPage = /** @class */ (function () {
    function MyordersPage(navCtrl, navParams, toastCtrl, ngZone, wp) {
    ...
    MyordersPage.prototype.getOrders = function (event) {
        var _this = this;
        if (event == null) {
            this.page = 1;
            this.myOrders = [];
        ...
        this.WooCommerce.getAsync('orders?customer=' + this.userId + '&page=' + this.page).then(function (orderData) {
            _this.ngZone.run(function () {
                _this.myOrders = _this.myOrders.concat(JSON.parse(orderData.body));
                _this.isLoading = false;
                console.log(_this.myOrders);
                console.log('paaaaaaaaaaaaaggggg:', _this.page);
            });
    ...
    MyordersPage.prototype.openOrderDetails = function (myOrder) {
        this.navCtrl.push('OrderDetails', { "order": myOrder });
    };
    MyordersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-myorders',template:/*ion-inline-start:"D:\test-mmarket\src\pages\myorders\myorders.html"*/'<!--\n  Generated template for the MyordersPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>سفارشات من</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding center>\n\n    <ion-spinner *ngIf="isLoading"></ion-spinner>\n\n    <div *ngIf="!isLoading && (myOrders.length == 0)">\n      <p>چیزی یافت نشد</p>\n    </div>\n  \n  <ion-list>\n    <ion-item *ngFor="let myOrder of myOrders" text-wrap (click)="openOrderDetails(myOrder)">\n      <h2>شماره سفارش: {{myOrder.id}} - {{myOrder.line_items.length}} کالا</h2>\n      <p>\n        <span>زمان ایجاد سفارش: {{myOrder.date_created | jalali}} </span>\n      </p>\n      <p>\n        <span>وضعیت: {{myOrder.status}}</span>\n        <span>مجموع: {{myOrder.total | number:0}} تومان</span>\n<!--         <span>user: {{myOrder.customer_id}}</span> -->\n      </p>\n      <button ion-button item-right icon clear>\n        <ion-icon name="arrow-forward"></ion-icon>\n      </button>\n    </ion-item>\n  </ion-list>\n  <ion-infinite-scroll (ionInfinite)="getOrders($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>'/*ion-inline-end:"D:\test-mmarket\src\pages\myorders\myorders.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["u" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgZone */], __WEBPACK_IMPORTED_MODULE_0__providers_woo_commerce_woo_commerce__["a" /* WooCommerceProvider */]])
    ], MyordersPage);
    return MyordersPage;
}());
