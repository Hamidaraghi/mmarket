            ...
            if (!versionData.up_to_date) {
                _this.alertCtrl.create({
                    ...
                    buttons: [{
                            text: "بروزرسانی",
                            handler: function () {
                                _this.InAppBrowser.create(versionData.download_url, "_blank", "location=yes");
                            }
                        }, {
                            text: 'خب',
                            handler: function () {
