...
var SearchPage = /** @class */ (function () {
    function SearchPage(navCtrl, toastCtrl, navParams, loadingCtrl, ngZone, wp, storage, networkInterface) {
        ...
        Promise.all(promises).then(function () {
            ...
            _this.wp.WooCommerce3.postAsync('sep/v1/search-stats', saveSearchData).then(function (data) {
                ...
                console.log('SSSEEEERRRR', res);
            });
        });
        this.WooCommerce.getAsync("products?search=" + this.searchQuery + "&status=publish").then((function (searchdata) {
    ...
    SearchPage.prototype.loadMoreProducts = function (event) {
        var _this = this;
        this.WooCommerce.getAsync("products?search=" + this.searchQuery + "&status=publish&page=" + this.page).then(function (searchData) {
            _this.ngZone.run(function () {
