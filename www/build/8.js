...
var ProductDetails = /** @class */ (function () {
    function ProductDetails(navCtrl, navParams, storage, toastCtrl, modalCtrl, formBuilder, http, ngZone, loadingCtrl, WP, events, imageViewerCtrl) {
        ...
        this.reviewValidator = formBuilder.group({
            name: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(30), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern('[a-zA-Zا-ی ]*')])],
